export default function PrivacyPolicy() {
    return (
      <main className="p-8">
        ...
        <p className="my-4 text-sm">Last updated: July 24, 2024</p>
        <p>
        ...
        <h3 className="text-2xl font-semibold my-2">Interpretation</h3>
        <p>
        ...
        <h3 className="text-2xl font-semibold my-2">Definitions</h3>
        <p>For the purposes of this Privacy Policy:</p>
        <ul className="px-4 pt-2 list-disc *:p-2">
          <li>
            <p>
          ...
          <li>
            <p>
              ...
              in this Agreement) refers to Support Hub.
            </p>
          </li>
          <li>
            <p>
          ...
          <li>
            <p>
              <strong>Website</strong> refers to Support Hub, accessible from{" "}
              <a
                href="https://supporthub.shivamvishwakarma.me"
                rel="external nofollow noopener"
                target="_blank"
              >
                https://supporthub.shivamvishwakarma.me
              </a>
            </p>
          </li>
          <li>
        ...
        <h2 className="text-3xl font-semibold my-2 text-center py-2">
        ...
        <ul>
          <li>
            <p>By email: shivamvishva552@gmail.com</p>
          </li>
          <li>
            <p>
              By visiting this page on our website:{" "}
              <a
                href="https://shivamvishwakarma.me/contact"
                rel="external nofollow noopener"
                target="_blank"
              >
                https://shivamvishwakarma.me/contact
              </a>
            </p>
          </li>
        </ul>
